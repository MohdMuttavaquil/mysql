      ...
      <div className='w-full'>
        ...
        {admain ? <form onSubmit={handleSubmit} className="sm:w-[80%] mx-auto min-h-[75vh] flex flex-col justify-center items-center gap-1">
          ...
          <label> <p>Enter Name</p>
            <input type="text" name="name" className="outline-none border-b-2 border-black" />
          </label>
          <label><p>Enter Password</p>
            <input type="password" name="password" onChange={handleChange} value={password} className="outline-none border-b-2 border-black" />
          </label>
